...
![[runInTargetDirAndSUIDLetsUsCatTheContents.png]]
...
That bypass is in CLI by the way, not in our .sh file.
...
![[ergergr.png]]and it will execute whatever code is set up in there.
